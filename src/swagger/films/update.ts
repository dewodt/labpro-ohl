...
export function SwaggerUpdateFilm() {
  return applyDecorators(
    ...
    // Request body
    ApiBody({
      description: 'Update film request body (form-data)',
      required: true,
      schema: {
        type: 'object',
        properties: {
    ...
    ApiOkResponse({
      ...
      content: {
        body: {
          example: ResponseDto.success('Successfully updated film', {
    ...
    ApiInternalServerErrorResponse({
      ...
      content: {
        body: {
          example: ResponseDto.error('Failed to update film'),
        },
      },
    }),
  );
